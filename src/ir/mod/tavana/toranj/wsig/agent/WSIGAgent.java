...
package ir.mod.tavana.toranj.wsig.agent;

import ir.mod.tavana.toranj.wsig.WSIGConfiguration;
import ir.mod.tavana.toranj.wsig.WSIGConstants;
import ir.mod.tavana.toranj.wsig.store.WSIGService;
import ir.mod.tavana.toranj.wsig.store.WSIGStore;
import ir.mod.tavana.toranj.wsig.uddi.UDDIManager;
import ir.mod.tavana.toranj.wsig.wsdl.JadeToWSDL;
import ir.mod.tavana.toranj.wsig.wsdl.WSDLConstants;
...
public class WSIGAgent extends GatewayAgent implements WSIGConstants {
	...
	private WSIGService createWSIGService(AID aid, ServiceDescription sd) throws Exception {
		...
		// Create wsdl
		System.out.println("*******************"+serviceName+" " + sd.toString());
		Definition def = JadeToWSDL.createWSDLFromSD(this, sd, wsigService);
