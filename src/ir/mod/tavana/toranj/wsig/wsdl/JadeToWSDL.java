...
package ir.mod.tavana.toranj.wsig.wsdl;

import ir.mod.tavana.toranj.wsig.WSIGConfiguration;
import ir.mod.tavana.toranj.wsig.store.ActionBuilder;
import ir.mod.tavana.toranj.wsig.store.MapperBasedActionBuilder;
import ir.mod.tavana.toranj.wsig.store.OntologyBasedActionBuilder;
import ir.mod.tavana.toranj.wsig.store.OperationName;
import ir.mod.tavana.toranj.wsig.store.SuppressOperation;
import ir.mod.tavana.toranj.wsig.store.TypedAggregateSchema;
import ir.mod.tavana.toranj.wsig.store.WSIGService;
...
public class JadeToWSDL {
	...
	private static Map<String, ObjectSchema> manageOntologyInputParameters(String tns, String soapStyle, XSDSchema wsdlTypeSchema, XSDModelGroup elementSequence, Message inputMessage, 
			AgentActionSchema actionSchema) throws Exception {
